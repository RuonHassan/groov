...
export default function MicrosoftCalendarCallback() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      localStorage.removeItem('microsoftOAuthState'); // Clean up
      ...
      try {
        ...
        const response = await fetch(
          `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/microsoft-calendar-callback`,
          {
            method: 'POST',
            headers: {
